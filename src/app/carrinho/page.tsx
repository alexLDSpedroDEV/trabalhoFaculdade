        ...
        <div className='bg-black'>
            <div className='grid grid-cols-4 col-1-[25vw] '>
                ...
                <div className='w-[auto] p-4'>
                    <div className={`bg-white grid grid-cols-1 grid-row-auto  md:w-[72vw] w-[94vw] h-[100%] min-h-[100vh] justify-center rounded-xl items-center`}>
                        <div className='grid justify-center items-start text-center p-2'>
